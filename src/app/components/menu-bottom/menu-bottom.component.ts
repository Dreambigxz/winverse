...
export class MenuBottomComponent {
    ...
    items: NavItem[] = [
      { label: 'Lobby', route: '/', key: '', path:"home" },
      ...
      { label: 'Matches', route: '/matches', key: 'matches', path:"chart-line" },
      { label: 'Tickets', route: '/trade', key: 'trade', path:"bolt" },

      // { label: 'Teams', route: '/', key: 'earnings', path:"users" },
      { label: 'Me', route: '/account', key: 'account', path:"user" },

      { label: 'Invite', route: '/invite', key: 'invite', path:"gift" },
